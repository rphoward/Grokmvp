...
`docs/`, user-owned `assets/`, reference product under `project-code/`. Default
active run: [`factory`](slice-runs/factory/) (`needs_slice_list`). New planning:
[`SPEC-SEED.stub.md`](intake/SPEC-SEED.stub.md). P1 proof archived:
[`grokmvp-phase1-proof`](../docs/references/grokmvp-phase1-proof/),
[`SPEC-SEED-grokmvp.md`](../docs/references/SPEC-SEED-grokmvp.md). Orientation:
...
2. The run `STATUS.md` named by `active_status` (currently
   `Planner/slice-runs/factory/STATUS.md`) — `current_mode`,
