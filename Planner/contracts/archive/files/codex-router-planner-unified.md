...
(router_planner
  ...
  ; ─── PROJECT SHAPE ────────────────────────────────────────────────────────
  ; A project is either single_phase or multi_phase. The shape is recorded
  ; on STATUS.md at slice-list creation time and consulted at closeout to
  ; decide phase_sealed vs project_complete when no phase_map exists.
  ...
  (run_dir_authority
    ...
    (skip_for create_phase_map create_slice_list_single_phase)
  ...
  (project_layer_mapping
    ...
    (capex3
      ...
      (source_of_truth
        "docs/AGENTS.md project boundaries section"))
  ...
  (router
    ...
    (if (phase_state phase_active)
      (cond_on STATUS
        ...
        (slice_review_needed   → review_gate)
  ...
  (final_closeout
    ...
    (sync_support_docs
      (paths AGENTS_md context_index_md)
      (rule  sync_if_repeat_active_run_state))
